document.addEventListener('DOMContentLoaded', function () {
  ...
  var SERVER_IP = '192.168.173.1';
  var SERVER_PORT = 9000;

  // DOM elements manipulated as user interacts with the app
  var messageBox = document.querySelector('#messages');
  var callerIdEntry = document.querySelector('#caller-id');
  var Ip_Server = document.querySelector('#ip_address');
  ...
  var change_ip = function(){
    var temp = SERVER_IP;
    SERVER_IP = Ip_Server.value;
    logMessage(temp+' Menjadi '+SERVER_IP);
  };

  // wire up button events
  changeBtn.addEventListener('click', change_ip)
